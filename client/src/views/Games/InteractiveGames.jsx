...
import { ArrowLeft, Brain, Ear, Hand, Palette, PenTool, Star } from 'lucide-react';
    ...
    <div className={`min-h-screen ${THEME.bgBeige} font-sans relative`}>
      <div className="max-w-5xl mx-auto p-6 py-10 flex flex-col h-full">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight">Choose a Game!</h1>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 animate-in slide-in-from-bottom duration-500">
          ...
          >
            ...
            <p className="text-green-100 font-bold text-sm">Find the hidden pairs!</p>
          </button>
          ...
          >
            ...
            <p className="text-red-100 font-bold text-sm">Tap bug as fast as you can!</p>
          </button>
          ...
          >
            ...
            <p className="text-blue-100 font-bold text-sm">Find shapes hidden in colors!</p>
          </button>
          ...
          >
            ...
            <p className="text-purple-100 font-bold text-sm">Listen and match the sounds!</p>
          </button>
          ...
          >
            ...
            <p className="text-yellow-100 font-bold text-sm">Draw and upload pictures!</p>
          </button>
        </div>
      </div>
    </div>
